...
import './camera.scss';
import { takePicture, scanBarcode, uploadPicture } from '../../controllers/camera';
      ...
      <View className="index">
        ...
        {this.state.preview ? null : (
          <View className="camera-span expand">
            <Camera frameSize="large" devicePosition="back" flash="auto" style="width:100%; height: 100%; left:0;top:0; "></Camera>
          </View>
        )}
        {this.state.preview ? (
          <View className="preview-span">
            <Image
              ...
              style="width:100%; height: 100%; left:0;top:0; background-size: 100%, 100%;"
              onClick={() => {
                //do preview
                Taro.previewImage({
                  urls: [this.state.src],
            ...
            <View style="display:flex; flex-direction:row; position:fixed; bottom: 100; left: 0; width:100%; height:100px">
