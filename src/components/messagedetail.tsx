...
export default function MessageDetail(props: MessageDetailProps) {
  return (
    <View style=" padding:0.5rem; margin-top:0.1rem; margin-left:1.2rem; margin-right:1.2rem;">
      ...
      <Text style="display:block; text-align:justify; font-size:1rem; ">{props.content}</Text>
      <Text style="display:block; text-align:right; font-size:1rem; margin-top:2rem; margin-bottom:1rem;">{props.sentTime}</Text>
      <AtButton
