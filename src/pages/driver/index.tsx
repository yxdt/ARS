...
export const TruckTypes: string[] = ['微型面包车', '面包车', '厢式货车2.5吨', '厢式货车5吨', '厢式货车10吨'];
  ...
  return (
    <View className="index">
      ...
      <View className="user-info-span">
        ...
        <Text className="form-comment">本系统只对LG注册司机开放， 请输入您的个人信息提交管理员审核。审核通过后，您就可以访问相关功能。</Text>
        <AtForm className="form-userinfo" onSubmit={onFormSubmit.bind(this)}>
          ...
          />
          <Picker className="picker" mode="selector" range={TruckTypes} value={truckType} onChange={handleChange.bind(this, 'truckType')}>
            <AtList>
